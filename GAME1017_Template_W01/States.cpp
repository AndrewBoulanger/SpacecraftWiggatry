...
void GameState::Enter()
{
	...
	m_pPlayer = new PlatformPlayer({ 0,0,400,152 }, { 512.0f,548.0f,50.0f,100.0f }, 
								   Engine::Instance().GetRenderer(), TEMA::GetTexture("player"));
	m_pEnemy = new Enemy({ 0,0,400,140 }, {800.0f, 550.0f, 50.0f, 100.0f}, Engine::Instance().GetRenderer(), TEMA::GetTexture("enemy"), 10, 10);
